...
do
	...
	grep -w -f /home/rejudcu/UKBB/RAPfiles/reference38/AllGenes.$chr.txt $testName.leftToDo.txt > $testName.toDo.$chr.txt
done
...
# invoke with e.g. 
# bash  ~/UKBB/RAPfiles/scripts/getAllScores.20231112.sh UKBB.migraine.20240118 migraine.20240118.bestGenes.txt for.UKBB.migraine.forAnnot.20240118.lst
